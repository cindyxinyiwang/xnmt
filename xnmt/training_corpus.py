...
class BilingualTrainingCorpus(Serializable):
  ...
  def __init__(self, train_src, train_trg, dev_src, dev_trg, train_id_file=None, dev_id_file=None, train_len_file=None, dev_len_file=None, dev_ref_file=None):
    ...
    self.train_len_file = train_len_file
    self.dev_len_file = dev_len_file
